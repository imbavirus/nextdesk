/*
  ...
  - Added the required column `isActive` to the `Peer` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Peer" ("alias", "hash", "id", "ownerId", "systemId", "userId") SELECT "alias", "hash", "id", "ownerId", "systemId", "userId" FROM "Peer";
DROP TABLE "Peer";
