/*
  ...
  - Added the required column `isActive` to the `UserToken` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_UserToken" ("id", "systemId", "token", "userId") SELECT "id", "systemId", "token", "userId" FROM "UserToken";
